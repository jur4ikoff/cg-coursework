...
inline shared_ptr<HittableList> pyramid(const Point3 &base_center,
...
inline shared_ptr<HittableList>
irregular_pyramid(const Point3 &v0,   // вершина 0 основания
...
// Создаёт пирамиду с произвольным четырёхугольным основанием и вершиной
inline shared_ptr<HittableList>
triangle_pyramid(const Point3 &v0,   // вершина 0 основания
                 const Point3 &v1,   // вершина 1 основания
                 const Point3 &v2,   // вершина 2 основания
                 const Point3 &apex, // вершина пирамиды
                 shared_ptr<Material> mat) {
