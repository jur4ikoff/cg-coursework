...
public:
  ...
  void add_ground_smoke(size_t obj_id, double density, double scale,
  ...
  void add_cylinder(const Point3 &center, double radius, double ymin,
                    double ymax);
  ...
  void add_triag_pyramid(const Point3 &v0, const Point3 &v1, const Point3 &v2,
                         const Point3 &up);
