...
CameraAddDialog::CameraAddDialog(
    Point3 lookfrom,
    Point3 lookat, double vfov,
    double defocus_angle,
    double focus_dist, QWidget *parent) : QDialog(parent),
                                          ui(new Ui::CameraAddDialog)
...
double CameraAddDialog::vfov() const
{
    return ui->fov->value();
}
...
double CameraAddDialog::focus_dist() const
{
    return ui->focus_dist->value();
}
